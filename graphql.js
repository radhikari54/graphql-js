...
function graphql(schema, requestString, rootValue, contextValue, variableValues, operationName, logFn) {
  return new _promise2.default(function (resolve) {
    ...
    if (validationErrors.length > 0) {
      ...
      resolve((0, _execute.execute)(schema, documentAST, rootValue, contextValue, variableValues, operationName, logFn));
    }
